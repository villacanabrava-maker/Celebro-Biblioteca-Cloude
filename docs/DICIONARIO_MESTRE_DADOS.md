...
**Status:** Base arquitetural para as migrations do Supabase
...
> Este arquivo é a cópia oficial do Dicionário Mestre enviado pelo usuário em 2026-09-16.
> É a fonte de verdade para nomes e significados do domínio "Cérebro Autoral". Mudanças
> estruturais no banco, na IA ou na interface devem preservar estes princípios ou atualizar
> formalmente a versão do dicionário (registrar em `docs/DECISOES.md`).
